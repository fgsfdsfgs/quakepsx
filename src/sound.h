...
#define SND_MAXVOL SPU_MAX_VOLUME


#define SND_NUM_CH (SPU_NUM_VOICES)
#define SND_NUM_CH_AMBIENT 3
...
#define SND_CLIPDIST 1024
#define SND_INV_CLIPDIST 4 // (1 / 1024)

#define ATTN_NONE   0
#define ATTN_NORM   (1 * ONE)
#define ATTN_IDLE   (2 * ONE)
#define ATTN_STATIC (3 * ONE)
